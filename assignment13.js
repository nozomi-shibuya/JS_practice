...
// 商品の定義
var itemList = [
    { id: '0001', name: 'ソファベッド', tags: ['ベッド', 'ソファ', '寝具'] , prices:[20000,10000,500]},
    { id: '0002', name: 'シングルベッド', tags: ['ベッド', 'ソファ', '寝具'] , prices:[20000,10000,500]},
    { id: '0003', name: '子ども用ベッド', tags: ['ベッド', 'ソファ', '寝具', '子ども部屋家具'], price:[20000,10000,500,8000]},
    { id: '0004', name: 'ソファ', tags: ['ソファ'], prices:[10000]},
    { id: '0005', name: 'キューブボックス', tags: ['家具・ラック', '収納システム'], prices:[3000,300]},
    { id: '0006', name: 'オープンラック', tags: ['家具・ラック', '収納システム'], prices:[3000,300]},
    { id: '0007', name: 'コンピュータデスク', tags: ['テーブル・椅子'], prices:[2000,1000]},
    { id: '0008', name: 'サイドテーブル', tags: ['テーブル・椅子'] ,prices:[2000,1000]},
    { id: '0009', name: 'ダイニングテーブル', tags: ['テーブル・椅子'] ,prices:[2000,1000]},
    { id: '0010', name: '子ども部屋用収納', tags: ['収納システム', '子ども部屋家具'],prices:[300,400]},
    { id: '0011', name: '小物器具', tags: ['包丁・ピューラー'], prices:[300,200]},
];
